...
# https://github.com/mlyg/DicePlusPlus/blob/main/src/loss_functions/loss_functions.py
# Implement focal_tversky_plusplus_loss inspired by focal_tversky_plus_plus_loss above
...
class FocalTverskyPlusPlusLoss(_Loss):
    """
    ...
    def __init__(
        ...
        alpha: float = 0.5,
        beta: float = 0.5,
        gamma_pp: float = 2.0,  # paper suggests around 2~3
        gamma_focal: float = 1.33,  # paper suggests around 4/3~2
